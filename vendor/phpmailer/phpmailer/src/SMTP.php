...
class SMTP
{
    ...
    public static $xclient_allowed_attributes = [
        'NAME', 'ADDR', 'PORT', 'PROTO', 'HELO', 'logging', 'DESTADDR', 'DESTPORT'
    ];
     ...
     * @param string $authtype The auth type (CRAM-MD5, PLAIN, logging, XOAUTH2)
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if (empty($authtype)) {
                ...
                foreach (['CRAM-MD5', 'logging', 'PLAIN', 'XOAUTH2'] as $method) {
        ...
        switch ($authtype) {
            ...
            case 'logging':
                //Start authentication
                if (!$this->sendCommand('AUTH', 'AUTH logging', 334)) {
                    return false;
                }
